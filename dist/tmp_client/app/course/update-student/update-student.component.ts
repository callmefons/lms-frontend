...
export class UpdateStudentComponent {
  ...
  next(){
    this.tabIndex == 2 ?  this.tabIndex = 2: this.tabIndex++;
    this.tabName = this.getTabName().name;
  }
  ...
  readFile(fileInput:any): any[] {
    ...
    reader.readAsText(fileInput[0], 'UTF8');
    ...
    reader.onload = function () {
      ...
      for (let i = 0; i <  lines.length; i++){
        ...
        if(lines[i][1] == 'นาย'){
          sex = 'mr';
        }else if (lines[i][1] == 'ด.ช.'){
          sex = 'boy'
        }else if(lines[i][1] == 'นางสาว'){
          sex = 'miss'
        }else{
          sex = 'girl'
        }

        let fakeImage = (sex == 'mr' || sex == 'boy'?
          "data:image/jpeg;base64," :
          "data:image/jpeg;base64,");


        let student:Student = new Student(lines[i][0], sex, lines[i][2], fakeImage);
  ...
  onChange(event:any) {
    this.students = this.readFile(event.srcElement.files);
  }
  ...
  submit(){
    ...
    let newStudents = new updateStudents(
      this.course_id,
      this.students
    );
